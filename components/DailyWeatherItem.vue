<template>
    <view class="container">
        ...
        <text class="text-field-title details">Temperatura w dzień: {{currentItem.temp.day}}&degC</text>
        <text class="text-field-title details">Temperatura odczuwalna w dzień: {{currentItem.feels_like.day}}&degC</text>
        <text class="text-field-title details">Temperatura w nocy: {{currentItem.temp.night}}&degC</text>
        <text class="text-field-title details">Temperatura odczuwalna w nocy: {{currentItem.feels_like.night}}&degC</text>
        ...
        <text class="text-field-title details">Wschód: {{currentItem.sunrise|moment}}</text>
        <text class="text-field-title details">Zachód: {{currentItem.sunset|moment}}</text>
